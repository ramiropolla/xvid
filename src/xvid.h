 ...
 *
 * $Id: xvid.h 2082 2014-04-08 20:19:42Z Isibaar $
 *
 ****************************************************************************/
...
#define FFEDIT_VOP_NOPIMB             (1<<15) /* no INTRA macroblocks in predicted frames */
#define FFEDIT_VOP_FORCE_MV           (1<<16) /* always write mvs for predicted frames (even if <0,0>) */
